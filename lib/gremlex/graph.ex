defmodule Gremlex.Graph do
  ...
  Returns a graph to allow chaining.
  """
  @spec element_map(Gremlex.Graph.t(), String.t() | list(String.t())) :: Gremlex.Graph.t()
  ...
  @spec element_map(Gremlex.Graph.t()) :: Gremlex.Graph.t()
  ...
  @spec e(t(), number | String.t() | list(number) | list(String.t())) :: t()
  ...
  @spec eq(Gremlex.Graph.t(), any()) :: Gremlex.Graph.t()
  def eq(graph, value) do
    enqueue(graph, "eq", [value])
  end

  @spec neq(Gremlex.Graph.t(), any()) :: Gremlex.Graph.t()
  def neq(graph, value) do
    enqueue(graph, "neq", [value])
  end
  ...
  @spec gte(Gremlex.Graph.t(), number()) :: Gremlex.Graph.t()
  def gte(graph, number) do
    enqueue(graph, "gte", [number])
  end
